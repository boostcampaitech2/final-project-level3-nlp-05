...
def retrieve_optimal_eps(df, vector, grid_numbers = 10, grid_lower = 0.1, grid_upper = 0.8):
    ...
    overall_score = -1
    model_best = None
    silhouette_score_optimal = None
    percentage_discarded_optimal = None
    ...
    print(f'"Epsilon:", {eps_best}, Silhouette score:", {silhouette_score_optimal:.2f}
                    , Proportion of News Discarded {percentage_discarded_optimal:.2f}') 
    return model_best
...
def main():
    ...
    file_path = f'../crawling/data/{args.date}'
